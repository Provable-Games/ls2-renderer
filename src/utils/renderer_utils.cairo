...
fn create_shinobi_svg(adventurer_id: u64, adventurer: Adventurer, adventurer_name: felt252, bag: Bag) -> ByteArray {
    ...
    format!(
        ...
        adventurer_id, _level, _xp, _name, _bag_item_1, _bag_item_2, _bag_item_3
    )
}
