...
use ls2_renderer::utils::renderer_utils::{
    SVGTheme, SVGPosition, SVGSize, get_default_theme, get_bag_theme, get_marketplace_theme, get_battle_theme,
    create_text_component, create_stat_component, create_health_bar_component, create_inventory_slot_component,
    create_logo_component, create_page_header_component, create_xp_badge_component
};
...
pub fn showcase_components() -> ByteArray {
    ...
    svg_content += create_text_component("Modular Components", text_pos, 16, @theme, "start", "text-top");
...
pub fn showcase_themes() -> ByteArray {
    ...
    svg_content += create_text_component("Default Theme", pos1, 14, @default_theme, "start", "text-top");
    ...
    svg_content += create_text_component("Marketplace Theme", pos3, 14, @marketplace_theme, "start", "text-top");
    
    // Battle theme
    let battle_theme = get_battle_theme();
    let pos4 = SVGPosition { x: 50, y: 200 };
    svg_content += create_text_component("Battle Theme", pos4, 14, @battle_theme, "start", "text-top");
