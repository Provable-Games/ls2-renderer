...
#[test]
fn test_basic_render_with_battle() {
...
fn test_render_with_different_ids() {
    ...
    let id1: u256 = 1;
    let meta1 = Renderer::render_with_battle(id1, mock_adv_addr, mock_beast_addr);
...
fn test_deterministic_rendering() {
    ...
    let result1 = Renderer::render_with_battle(token_id, mock_adv_addr, mock_beast_addr);
...
fn test_render_performance() {
    ...
    let result = Renderer::render_with_battle(1, mock_adv_addr, mock_beast_addr);
